...
public class UserDAO {
    ...
    public boolean registerUser(User user) {
        ...
        try (Connection conn = Database.getConnection()) {
            ...
            try (PreparedStatement getPokeStmt = conn.prepareStatement(getRandomPokemonSQL); PreparedStatement givePokeStmt = conn.prepareStatement(givePokemonSQL)) {
            ...
            try (PreparedStatement getItemStmt = conn.prepareStatement(getItemIdSQL); PreparedStatement giveItemStmt = conn.prepareStatement(giveItemSQL)) {
